  ...
  return {
    ...
    blocks: [
      ...
      b(
        ...
        "Each of these is work we deliver regularly. Your project will differ in scope, but the shape is familiar.",
        [
          [
            "Business website with enquiry and booking",
            "A marketing site built around one action: getting a qualified enquiry. Service pages designed for search, a booking or enquiry flow that reaches the right inbox, and an admin panel the owner can run without a developer.",
            "/services/frontend-development",
            "/assets/main-software-engineering.webp",
            "A business website layout on a laptop",
          ],
          [
            "E-commerce storefront",
            "A product catalogue, search and filtering, a checkout that works on a phone, and the analytics needed to see where buyers drop out. Built to stay fast as the catalogue grows.",
            "/services/frontend-development",
            "/assets/marketing-ecommerce.webp",
            "An online store product listing",
          ],
          [
            "Mobile app for customers",
            "An app built around the few moments that matter — finding a service, booking it, staying informed — with a backend that the website and the app can both use.",
            "/services/mobile-app-development",
            "/assets/main-secure-experience-design.webp",
            "A mobile application interface",
          ],
          [
            "Internal tool and workflow automation",
            "Replacing spreadsheets and manual follow-up with a system that records the work, chases what is overdue and shows the team what needs attention today.",
            "/services/ai-workflow-automation",
            "/assets/marketing-analytics.webp",
